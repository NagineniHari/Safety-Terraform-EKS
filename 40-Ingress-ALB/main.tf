...
resource "aws_lb_listener" "ingress_alb" {
  ...
  certificate_arn   = local.ingress_alb_certificate_arn        # ARN of your SSL certificate
  ...
  default_action {
    ...
    fixed_response {
      ...
      message_body = "<h1>Hi, am from Ingress ALB HTTPS Health Check for Pod and Nodes</h1>"
      status_code  = "200"
    }
  }
